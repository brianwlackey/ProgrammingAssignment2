## These two functions will work together to calculate and cache the inverse of
## a matrix.

## This first function will create a list, which is really a list containing a
## function to:
...
## This second function calculates the inverse of the list created with the 
